...
inline CodingStatus next_mcupos(const ScanInfo& scan_info, const std::unique_ptr<FrameInfo>& frame_info, int rsti, int* mcu, int* cmp, int* csc, int* sub, int* dpos, int* rstw) {
